    ...
    subscription = shoppingCartStore.subscribe((cart: ShoppingCartState) => {
      ...
      if (cart.shippingAddress) {
        if (!shippingAddress || shippingAddress._id !== cart.shippingAddress._id) {
          ...
          productService
            .getTaxAndShipping(cart.shippingAddress)
      ...
      <IonContent className="cart-content">
        ...
        <div className="billing-summary">
          <div className="title">
            ...
            <div><IonIcon icon={showBillingSummary ? caretUpOutline : caretDownOutline} onClick={(e) => {
          ...
          {showBillingSummary ? (
            <div className="details">
              ...
              {paymentMethod?.address_line2 ? (
                <div>{paymentMethod?.address_line2}</div>
              ) : ''}
              <div>{paymentMethod?.address_city} {paymentMethod?.address_state}</div>
        ...
        <div className="shipping-summary">
          <div className="title">
            ...
            <div><IonIcon icon={showShippingSummary ? caretUpOutline : caretDownOutline} onClick={(e) => {
        ...
        <div className="payment-summary">
          <div className="title">
            <div>Payment</div>
            <div><IonIcon icon={showPaymentSummary ? caretUpOutline : caretDownOutline} onClick={(e) => {
          ...
          {showPaymentSummary ? (
            <div className="details payment">
              ...
              <div>
                ...
                <div>Exp. {paymentMethod?.exp_month}/{paymentMethod?.exp_year}</div>
                <div>{paymentMethod?.name}</div>
              </div>
            </div>
          ) : ''}
        ...
        <div className="footer">
          <div className="button-container">
            <Button label="Place Order" large={true} onClick={(e: any) => {
              e.preventDefault();
              e.stopPropagation();
              checkout();
            }} />
