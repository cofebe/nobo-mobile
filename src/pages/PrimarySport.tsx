     ...
     <IonRow>
      <IonCol className="nobo-center" size="11">
       <IonItem
        ...
        className={'primary-sport-input ' + (isActiveSport('wbasketball') ? 'selected' : '')}
       >
        <IonLabel className="primary-sport-label" style={{ color: '#00816D' }}>
         Women's Basketball
        </IonLabel>
     ...
     <IonRow>
      <IonCol className="nobo-center" size="11">
       <IonItem
        ...
        className={'primary-sport-input ' + (isActiveSport('mbasketball') ? 'selected' : '')}
       >
        <IonLabel className="primary-sport-label" style={{ color: '#00816D' }}>
         Men's Basketball
        </IonLabel>
     ...
     <IonRow>
      <IonCol className="nobo-center" size="11">
       <IonItem
        ...
        className={'primary-sport-input ' + (isActiveSport('wvolleyball') ? 'selected' : '')}
       >
        <IonLabel className="primary-sport-label" style={{ color: '#00816D' }}>
         Women's Volleyball
        </IonLabel>
     ...
     <IonRow>
      <IonCol className="nobo-center" size="11">
       <IonItem
        ...
        className={'primary-sport-input ' + (isActiveSport('mvolleyball') ? 'selected' : '')}
       >
        <IonLabel className="primary-sport-label" style={{ color: '#00816D' }}>
         Men's Volleyball
        </IonLabel>
