      ...
      <IonContent>
        <IonRow>
          <IonCol offset="1" size="10">
            ...
            <h4>Introduction</h4>
            URP+ Inc. (“URP+” or “we”) respects your privacy and are committed to
            protecting it through our compliance with this policy. This policy describes:
            <p style={{paddingLeft: "1rem"}}>• The types of information we may collect or that you may provide
            when you download, install, register with, access, or use the URP+
            website (the “Website”) and mobile applications (the “Application”)
            (collectively referred to as the “Service”).</p>
            <p style={{paddingLeft: "1rem"}}>• Our practices for collecting, using, maintaining, protecting, and
            disclosing that information. </p>
            <br></br>This policy applies only to information we collect in the Service and in
            email, text, and other electronic communications sent through or in
            connection with the Service.
            This policy DOES NOT apply to information that:
            <p style={{paddingLeft: "1rem"}}>• We collect offline or on any other company apps or websites,
            including websites you may access through our Service. </p>
            <p style={{paddingLeft: "1rem"}}>• You provide to or is collected by any third party (see Third-Party
            ...
            (collectively, “COPPA”) require us to inform parents and legal guardians (as 

            used in this section, “parents”) about our practices for collecting, using,
            and disclosing personal information from children under the age of 13
            (“children”). It also requires us to obtain verifiable consent from a child's
            parent for certain collection, use, and disclosure of the child's personal
            information.
            This section notifies parents of:
            <p style={{paddingLeft: "1rem"}}>1. The types of information we may collect from children.</p>
            ...
            <p style={{paddingLeft: "1rem"}}>4. Our practices for notifying and obtaining parents' consent
            when we collect personal information from children,
            including how a parent may revoke consent.</p>
            <p style={{paddingLeft: "1rem"}}>5. All operators that collect or maintain information from
            children through this Service.</p>
            This section only applies to children under the age of 13 and
            supplements the other provisions of this Privacy Policy. Only the other
            provisions of this Privacy Policy apply to teens and adults.
            <h5>1. Information We Collect from Children</h5>
            Children can access many parts of the Service and its content and
            use many of its features without providing us with personal information.
            However, some content and features are available only to registered users
            or require us to collect certain information, including personal information,
            from them. In addition, we use certain technologies, such as cookies, to
            automatically collect information from our users (including children) when
            they visit or use the Service.<br></br>
            We only collect as much information about a child as is reasonably
            necessary for the child to participate in an activity, and we do not condition
            his or her participation on the disclosure of more personal information than
            is reasonably necessary.<br></br>
            <b>Information We Collect Directly.</b> A child must provide us with the
            following information to register with this website: the child's first name,
            birth date, and a parent's email address. We also require the child to create 
            a member name and password. We may request additional information
            from your child, but this information is optional. We specify whether
            information is required or optional when we request it.<br></br>
            We enable registered users to communicate with others on or
            through this Service through chat, email and posting to public areas of the
            Service ("Social Features"). The nature of these features allows children
            to disclose personal information about themselves. We do not monitor or
            review this content before it is posted, and we do not control the actions of
            third parties with whom your child shares his or her information. We
            encourage parents to educate their children about safe internet use and to
            monitor their children's use of social features.
            Automatic Information Collection and Tracking. We use
            technology to automatically collect information from our users, including
            children, when they access and navigate through the Service and use
            certain of its features. The information we collect through these
            technologies may include:
            <p style={{paddingLeft: "1rem"}}>• One or more persistent identifiers that can be used to recognize
            a user over time and across different websites and online
            services.</p>
            <p style={{paddingLeft: "1rem"}}>• Information that identifies a device’s location (geolocation
            information).</p>
            We also may combine non-personal information we collect through
            these technologies with personal information about you or your child that
            we collect online.
            For information about our automatic information collection practices,
            including how you can opt out of certain information collection, see the
            "Automatic Information Collection and Tracking" and "Choices About How
            We Use and Disclose Your Information" sections of our general Privacy
            Policy.
            ...
            <p style={{paddingLeft: "1rem"}}>• communicate with him or her about activities or features of the
            Service that may be of interest;</p>
            We use the information we collect automatically through technology
            (see Automatic Information Collection and Tracking) and other nonpersonal information we collect to improve our Service and to deliver a
            ...
            <p style={{paddingLeft: "1rem"}}>• Store information about the child’s preferences, allowing us to
            customize the content according to individual interests.</p>
            ...
            We may disclose aggregated information about many of our users. In
            ...
            <p style={{paddingLeft: "1rem"}}>• If we believe disclosure is necessary or appropriate to protect
            the rights, property, or safety of URP+, our customers or others,
            including to:
              ...
              <p style={{paddingLeft: "1rem"}}>- To law enforcement agencies or for an investigation related to public safety.</p>
            </p>

            <b>Social Features.</b> The Service offers social features, including in-app
            messaging, chat, and posting on message boards, that enable children
            communicate with others on or through the Service. We do not control the
            types of information your child can send or post through them. We
            encourage parents to educate their children about safety online and to
            carefully monitor their children's use of social features to ensure they do
            not disclose their personal information through them.
            ...
            maintained by us, require us to correct or delete the personal information,
            and/or refuse to permit us from further collecting or using the child's
            information.
            You can review, change, or delete your child's personal information
            by:
            ...
            No other third-party operators may collect or maintain personal
            information from children through the Service. {/*Commented [JC2]: Is this correct? To be COPPA compliant you
...
*/}
            ...
            When you download, register with, or use this Service, we may ask you
            provide information:
            <p style={{paddingLeft: "1rem"}}>• By which you may be personally identified, such as full name, postal
            address, email address, date of birth, or telephone number
            (“personal information”).</p>
            <p style={{paddingLeft: "1rem"}}>• That is about you but individually does not identify you, such as place
            of birth, geographical indicators, employment information (for
            coaches), education information (provided by users).</p>
            This information includes:
            <p style={{paddingLeft: "1rem"}}>• Information that you provide by filling in forms in the Service. This
            includes information provided at the time of registering to use the
            Service, subscribing to our service, posting material, and requesting
            further services. We may also ask you for information when you
            report a problem with the Service.</p>
            ...
            and transmitted to others at your own risk. Additionally, we cannot control
            ...
            When you download, access, and use the Service, it may use technology
            to automatically collect:
            <p style={{paddingLeft: "1rem"}}>• Usage Details. When you access and use the Service, we may
            automatically collect certain details of your access to and use of the
            Service, including traffic data, location data, logs, and other
            communication data and the resources that you access and use on or
            through the Service.</p>
            <p style={{paddingLeft: "1rem"}}>• Device Information. We may collect information about your mobile
            device and internet connection, including the device’s unique device
            identifier, IP address, operating system, browser type, mobile network
            information, and the device’s telephone number.</p>
            <p style={{paddingLeft: "1rem"}}>• Stored Information and Files. The Service also may access
            ...
            video clips, personal contacts, and address book information.</p>
            <p style={{paddingLeft: "1rem"}}>• Location Information. This Service does not collect real-time
            ...
            <p style={{paddingLeft: "1rem"}}>• Cookies (or mobile cookies). A cookie is a small file placed on your
            computer or smartphone. It may be possible to refuse to accept
            cookies by activating the appropriate setting on your computer or
            smartphone. However, if you select this setting, you may be unable to
            access certain parts of our Service.</p>
            <h4>Third-Party Information Collection</h4>
            When you use the Service or its content, certain third parties may use
            automatic information collection technologies to collect information about
            you or your device. These third parties [may] include:
            ...
            collection.</p>
            <p style={{paddingLeft: "1rem"}}>• Notify you when Service updates are available, and of changes to
            any products or services we offer or provide though it.</p>
            The usage information we collect helps us to improve our Service and to
            deliver a better and more personalized experience by enabling us to:
            <p style={{paddingLeft: "1rem"}}>• Estimate our audience size and usage patterns.</p>
            <p style={{paddingLeft: "1rem"}}>• Store information about your preferences, allowing us to customize
            our Service according to your individual interests.</p>
            <p style={{paddingLeft: "1rem"}}>• Speed up your searches.</p>
            ...
            respond to any government or regulatory request.</p>
            <p style={{paddingLeft: "1rem"}}>• To enforce our rights arising from any contracts entered into between
            you and us, including the Terms of Service, and for billing and
            collection, if applicable.</p>
            <p style={{paddingLeft: "1rem"}}>• If we believe disclosure is necessary or appropriate to protect the
            rights, property, or safety of URP+, our customers or others.</p>

            <h4>Your Choices About Our Collection, Use, and Disclosure of Your
            Information</h4>
            ...
            <p style={{paddingLeft: "1rem"}}>• Tracking Technologies. You can set your browser to refuse all or
            some browser cookies, or to alert you when cookies are being sent. If
            you disable or refuse cookies or block the use of other tracking
            technologies, some parts of the Service may then be inaccessible or
            not function properly.</p>
            <p style={{paddingLeft: "1rem"}}>• Location Information. You can choose whether or not to allow the
            Service to collect and use real-time information about your device’s
            location through the device’s privacy settings. If you block the use of
            location information, some parts of the Service may become
            inaccessible or not function properly.</p>
            ...
            Rights for more information. {/*Commented [JC4]: Link to this section below */}
            ...
            have been copied or stored by other Service users. Proper access and use
            of information provided on the Service, including User Contributions, is
            ...
            rights regarding our use of their personal information. To learn more about
            California residents’ privacy rights, visit https://oag.ca.gov/privacy/ccpa and
            ...
            secure servers behind firewalls. Any payment transactions will be
            ...
            certain parts of our Service, you are responsible for keeping this password
            confidential. We ask you not to share your password with anyone. We urge
            you to be careful about giving out information in public areas of the Service
            like message boards. The information you share in public areas may be
            viewed by any user of the Service.<br></br>
            ...
            information transmitted through our Service. Any transmission of personal
            ...
            changes to how we treat our users’ personal information, we will post the
            ...
            deliverable email address and/or phone number for you and for periodically
            visiting this privacy policy to check for any changes.
            <h3>Contact Information</h3>
            <p>To ask questions or comment about this privacy policy and our privacy
            practices, contact us at:</p>
