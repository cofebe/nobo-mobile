...
const Logo: React.FC = () => {
 ...
 return (
  ...
  >
   ...
   >
    <p style={{ marginTop: 0 }}>
     URP+, Ultimate Recruiting Profile is your sports-centered professional social network. Athletes
     of all ages can create an all encompassing recruiting focused profile to network and connect
     amongst coaches and trainers who are also able to create profiles! Sign up, promote yourself
     and join us to Discover Who's Next! Download our app today, sign up and create a profile, and
     start building up the future of sports networking!
    </p>
   </div>
   <div
    style={{
