      ...
      <IonContent className="trade-summary-content">
        <div>
            ...
            <IonRow className="data">
              <IonCol className="your-item" size="4" offset="1">
                <div
                  ...
                  style={{
                    backgroundImage: cart.productOffered?.images?.length
                      ? getImageUrl(cart.productOffered.images[0]?.url)
                      : '',
                  }}
                ></div>
                <div className="text">
              ...
              <IonCol className="their-item" size="4">
                <div
                  className="item-image"
                  style={{
                    backgroundImage: cart.productWanted?.images?.length
                      ? getImageUrl(cart.productWanted.images[0]?.url)
                      : '',
                  }}
                ></div>
                <div className="text">
            ...
            <IonRow className="summary-line">
              <IonCol size="4" offset="1">
                ...
                <span className="price">
                  {formatPrice(cart.tradeFee + cart.shipping + cart.tax)}
                </span>
              </IonCol>
              <IonCol size="4" offset="2">
                They pay{' '}
          ...
          <div className="description">
            <p>
              To complete the transaction you will have to pay {cart.tradeFeePercentage * 100}%
              trade transaction fee of {formatPrice(cart.tradeFee)} and {formatPrice(cart.shipping)}{' '}
              shipping fee.
            </p>
            <p className="italic">
              Note, you will only be charged once the other party accepts the trade.{' '}
              <span>
                All Trades are Final. No Returns will be accepted if the other party accepts the
                transaction.
              </span>
            </p>
          </div>
            ...
            {showDetails ? (
              <div>
                <div className="summary-info">
                  ...
                  <div className="value">
                    {formatPrice(
                      (cart.productWanted?.price || 0) + (cart.productOffered?.price || 0)
                    )}
                  </div>
                </div>
                <div className="summary-info">
