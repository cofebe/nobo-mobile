		...
		<IonPage className="home-page-athlete-profile" style={{ backgroundColor: '#F9FBFB' }}>
			<IonContent className="athlete-profile-content" scrollY={false}>
				...
				>
					<IonContent className="ion-padding">
						<IonButton className="nobo-qr-code-btn-close" onClick={() => profileModal.current?.dismiss()}>
							Cancel
						</IonButton>
					</IonContent>
					<IonHeader></IonHeader>
				...
				<IonRow className="nobo-menu-container">
					<div className="nobo-menu-circle" onClick={() => setTargetSection('Feed')}>
						<div className="circle-background">
							<img
								className={
									targetSection === 'Feed' ? 'nobo-profile-menu-selected' : 'nobo-profile-menu-not-selected'
								}
			...
			{modalVisible && (
				<div className="nobo-modal">
					...
					<h5 className="profile-modal-text">GO TO YOUR STYLE FEED TO CONNECT WITH THE COMMUNITY!</h5>
