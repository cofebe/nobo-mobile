...
import './TradePendingCloset.scss';
import Header from '../components/Header';
import { UserService } from '../services/UserService';
import { Product } from '../models';
import { formatPrice } from '../utils';

const TradePendingCloset: React.FC = () => {
 ...
 return (
  <IonPage className="trade-pending-closet-container">
   <Header title="Pending Approvals" />
   <IonContent className="trade-pending-closet-content">
    {products.length > 0 ? (
...
export default TradePendingCloset;
