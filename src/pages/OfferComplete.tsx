  ...
  <IonPage className="offer-complete-container">
   ...
   <IonContent className="offer-content">
    <div className="thank-container">
     ...
     <div className="text">
      <div>
       If the other party accepts your request, you will be charged and the product will be shipped.
       An email notification, with your offer details has been sent to your inbox. You can always
       check the status of your offer in YOUR OFFERS.
      </div>
     </div>
    </div>
