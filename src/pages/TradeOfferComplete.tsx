   ...
   <IonContent className="trade-complete-content">
    <div>
     <div className="thank-container">
      ...
      <div className="text">
       <p>
        Once the other party accepts the trade, you will be charged and this ‘new for you’ product
        will be shipped.
       </p>
       <p>
        An email notification, with your trade transactions order details, has been sent to your
        inbox. You can always check the status of the trade in your account dashboard.
       </p>
      </div>
     </div>
