import { IonAvatar, IonCol, IonItem, IonRow } from '@ionic/react';
      ...
      {reviewData.map((review: any, index: any) => (
        ...
        >
          ...
          <IonCol
            ...
            size="4"
          >
            <div className="review-rating">{renderStars(review.ratingNum)}</div>
          </IonCol>
        </IonRow>
      ))}
      {reviewData.length === 0 && (
