...
const CreateCommentModal = forwardRef<Ref, CreateCommentModalProps>(
  ({ postId, onCancel, onClose }, ref) => {
      ...
      >
        ...
        <IonContent className="post-comment-content" scrollY={false}>
          <IonItem className="nobo-post-input-area">
            ...
            <img className="post-comment-create-bubble" src={profilePic} alt="avatar"></img>
            <div className="nobo-post-tool-menu" style={{ display: 'none' }}>
              ...
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <circle cx="12" cy="12" r="12" fill="#CCDBDC" fill-opacity="0.2" />
                <path
            ...
            <IonRow>
              <IonCol className="nobo-center" size="11">
                <IonItem
                  ...
                  detail={true}
                >
                  <IonLabel className="nobo-add-location-label">Add Location</IonLabel>
