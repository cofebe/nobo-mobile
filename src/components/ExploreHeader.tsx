     ...
     <IonRow>
      ...
      <IonCol size="3">
       <IonButton
        ...
        style={{
         '--box-shadow': activeButton === 'trade' ? '0px 0px 10px rgba(214, 152, 14, 0.4)' : 'none',
      ...
      <IonCol size="3">
       <IonButton
        ...
        style={{
         '--box-shadow': activeButton === 'shop' ? '0px 0px 10px rgba(214, 152, 14, 0.4)' : 'none',
      ...
      <IonCol size="3">
       <IonButton
        ...
        style={{
         '--box-shadow': activeButton === 'sale' ? '0px 0px 10px rgba(214, 152, 14, 0.4)' : 'none',
