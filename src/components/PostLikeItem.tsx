  ...
  return (
    <IonItem lines="none" className="post-like-item" detail={false}>
      <IonRow className="post-like-item-content ion-text-wrap">
        ...
        <IonCol className="feed-content feed-content-center" size="7">
          <div>
        ...
        <IonCol className="feed-content-center feed-content-right" size="4">
          <div style={{ width: '100%' }}>
            <h2 className="feed-list-nobo-badge-line">
              <span>
        ...
        <IonCol className="feed-content feed-content-stats" size="11" offset="1">
          <div>
            {likeItem.account_type === 'athlete' ? (
