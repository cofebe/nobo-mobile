...
const CreatePraiseModal = forwardRef<Ref, CreatePraiseModalProps>(
  ({ userId, onCancel, onClose }, ref) => {
        ...
        .then(data => {
          setProfilePic(
            data.basic_user_profile.profile_image?.String ||
              `https://cofebe-upload-files.s3.us-west-2.amazonaws.com/pictures/${myUserID}/profile.jpeg?fail`
          );
        });
    }, [userId]);
    ...
    function postPraise() {
      ...
      userService.postPraise(userId, req).then(() => {
        setData('');
    ...
    return (
      <IonModal
        className="post-praise-container"
        ref={ref}
      ...
      >
        ...
        <IonContent className="post-praise-content" scrollY={false}>
          <IonItem className="nobo-post-input-area">
            ...
            <img className="post-praise-create-bubble" src={profilePic} alt="avatar"></img>
            <div className="nobo-post-tool-menu" style={{ display: 'none' }}>
              ...
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <circle cx="12" cy="12" r="12" fill="#CCDBDC" fillOpacity="0.2" />
                <path
