...
import { IonContent, IonItem, IonButton, IonTextarea, IonModal } from '@ionic/react';
...
const SendMessageModal = forwardRef<Ref, SendMessageModalProps>(
  ({ orderId, productId, onCancel, onClose }, ref) => {
