  ...
  return (
    <IonItemSliding id="slidingItem" className="connection-list-item">
      <IonItem lines="none" className="connection-item" detail={false}>
        <IonRow className="ion-text-wrap connection-row" onClick={
            (e) => {
              e.preventDefault();
      ...
      <IonItemOptions>
        <IonItemOption onClick={(e: any) => deleteItem(connection)} className="reject-connection"><IonIcon icon={trashOutline} /></IonItemOption>
      </IonItemOptions>
    </IonItemSliding>
  );
};
