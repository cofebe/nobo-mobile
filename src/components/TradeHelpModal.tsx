        ...
        <IonGrid className="trade-tooltip">
          ...
          <IonRow className="bullet">
            ...
            <IonCol size="11" className="value">
              ...
              <p>
                ...
                of the trade transaction fee, we will ship your product to them, and theirs to you!
                Hang tight, your “new for you” luxury product is on the way!
              </p>
            </IonCol>
          </IonRow>
          ...
          <IonRow className="bullet">
            ...
            <IonCol size="11" className="value">
              ...
              <p>
                Contact us:{' '}
                <a href="mailto:customerservice@thenobo.com">customerservice@thenobo.com</a>
              </p>
