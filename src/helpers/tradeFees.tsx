...
export function calculateEstPrice(productPrice: any) {
  ...
  let noboFeeMin = (getNoboFee(tradeTransactionValue) * tradeTransactionValue) / 100 / 2;
  // second product is estimated to have 20% higher price
  tradeTransactionValue = productPrice * 2.166;
  let noboFeeMax = (getNoboFee(tradeTransactionValue) * tradeTransactionValue) / 100 / 2;
