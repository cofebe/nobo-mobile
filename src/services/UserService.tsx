...
export class UserService extends BaseService {
 ...
 async getPurchases(): Promise<FullOrder> {
  let token = this.authService.getUserToken();
  console.log(' token from userservice   ----', token);
  const url = 'https://staging.thenobo.com/api/orders/my-purchases';
  const response = await fetch('https://staging.thenobo.com/api/orders/my-purchases', {
   headers: {
    'Content-Type': 'application/json',
