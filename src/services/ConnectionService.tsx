...
export class ConnectionService extends BaseService {
    ...
    async acceptConnection(connectionID: number) {
        const response = await super.fetch('POST', `/connections/${connectionID}`, { "new_status": "connected" });
    ...
    async rejectConnection(connectionID: number) {
        const response = await super.fetch('POST', `/connections/${connectionID}`, { "new_status": "rejected" });
    ...
    async removeConnection(connectionID: number) {
        const response = await super.fetch('POST', `/connections/${connectionID}`, { "new_status": "removed" });
